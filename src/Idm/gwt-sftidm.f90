...
module GwtSftInputModule
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtsft_options_concentration = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'SFT', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtsft_rainfall = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'SFT', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtsft_evaporation = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'SFT', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtsft_runoff = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'SFT', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtsft_inflow = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'SFT', & ! subcomponent
    'PERIOD', & ! block
