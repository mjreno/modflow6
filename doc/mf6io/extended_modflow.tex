...
Extended \mf can read and write version 4 NetCDF (Network Common Data Form) files. Two different formats are supported for each (input and output) file type: a structured format and a UGRID (Unstructured Grid) based unstructured Layered Mesh format. Each format aims to be cf-conventions compliant.
