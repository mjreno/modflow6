...
module GweGweExchangeModule
  ...
  type, extends(DisConnExchangeType) :: GweExchangeType
    ...
    class(GweModelType), pointer :: gwemodel1 => null() !< pointer to GWT Model 1
    class(GweModelType), pointer :: gwemodel2 => null() !< pointer to GWT Model 2
    !
...
contains
  ...
  subroutine read_mvt(this, iout)
    ...
    character(len=LENMEMPATH) :: mvemempath
    !
    ...
    mvemempath = create_mem_path(mname, 'MVE', idm_context)
    call mvt_cr(this%mvt, this%name, mvemempath, this%inmvt, iout, &
                this%gwemodel1%fmi, this%gwemodel1%eqnsclfac, &
                this%gwemodel1%depvartype, gwfmodelname1=this%gwfmodelname1, &
                gwfmodelname2=this%gwfmodelname2, fmi2=this%gwemodel2%fmi)
