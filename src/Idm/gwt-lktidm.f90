...
module GwtLktInputModule
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtlkt_options_concentration = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'LKT', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtlkt_rainfall = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'LKT', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtlkt_evaporation = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'LKT', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtlkt_runoff = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'LKT', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtlkt_ext_inflow = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'LKT', & ! subcomponent
    'PERIOD', & ! block
