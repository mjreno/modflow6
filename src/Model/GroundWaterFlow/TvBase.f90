...
module TvBaseModule
  ...
  type, abstract, extends(NumericalPackageType) :: TvBaseType
    integer(I4B), dimension(:, :), pointer, contiguous :: cellid !< cellid of time varying value
    type(CharacterStringType), dimension(:), pointer, &
      contiguous :: tv_type => null() !< type of time varying value
    real(DP), dimension(:), pointer, contiguous :: tv_value !< time varying value
