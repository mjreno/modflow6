...
module SwfOcInputModule
  ...
  private
  public swf_oc_param_definitions
  public swf_oc_aggregate_definitions
  public swf_oc_block_definitions
  public SwfOcParamFoundType
  public swf_oc_multi_package
  public swf_oc_subpackages
  ...
  type SwfOcParamFoundType
    ...
    logical :: steps = .false.
  end type SwfOcParamFoundType

  logical :: swf_oc_multi_package = .false.
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_budfilerec = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_budget = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_fileout = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_budgetfile = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_budcsvfilerec = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_budgetcsv = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_budgetcsvfile = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_qoutfilerec = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_qoutflow = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_qoutflowfile = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_stagefilerec = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_stage = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_stagefile = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_qoutprintrec = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_print_format = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_formatrecord = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_columns = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_width = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_digits = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_format = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_saverecord = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_save = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_printrecord = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_print = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_rtype = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_first = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_last = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_frequency = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    swfoc_steps = InputParamDefinitionType &
    ( &
    'SWF', & ! component
    'OC', & ! subcomponent
    'PERIOD', & ! block
