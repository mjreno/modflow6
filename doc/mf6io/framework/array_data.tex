...
Note that the \mf Extended build also supports an optional NETCDF keyword.  This keyword is not compatible with the LAYERED keyword and is a valid option only if a model NetCDF (Network Common Data Form) input file is configured.  For more information see the Extended \mf section.
