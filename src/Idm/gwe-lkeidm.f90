...
module GweLkeInputModule
  ...
  type(InputParamDefinitionType), parameter :: &
    gwelke_options_temperature = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'LKE', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwelke_rainfall = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'LKE', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwelke_evaporation = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'LKE', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwelke_runoff = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'LKE', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwelke_ext_inflow = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'LKE', & ! subcomponent
    'PERIOD', & ! block
    'EXT-INFLOW', & ! tag name
    'EXT_INFLOW', & ! fortran variable
    'DOUBLE', & ! type
    '', & ! shape
