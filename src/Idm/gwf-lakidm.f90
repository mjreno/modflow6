...
module GwfLakInputModule
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_stage = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_rainfall = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_evaporation = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_runoff = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_inflow = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_withdrawal = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
    'WITHDRAWAL', & ! tag name
    'WITHDRAWAL', & ! fortran variable
    'DOUBLE', & ! type
    'NLAKES', & ! shape
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_rate = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_invert = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
    'INVERT', & ! tag name
    'INVERT', & ! fortran variable
    'DOUBLE', & ! type
    'NOUTLETS', & ! shape
    'invert elevation', & ! longname
    .true., & ! required
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_rough = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_width = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwflak_slope = InputParamDefinitionType &
    ( &
    'GWF', & ! component
    'LAK', & ! subcomponent
    'PERIOD', & ! block
