...
module GwtUztInputModule
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtuzt_options_concentration = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'UZT', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtuzt_infiltration = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'UZT', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwtuzt_uzet = InputParamDefinitionType &
    ( &
    'GWT', & ! component
    'UZT', & ! subcomponent
    'PERIOD', & ! block
