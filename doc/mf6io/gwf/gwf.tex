...
The GWF Model must be solved by an Iterative Model Solution (IMS) package.
...
\newpage
\subsection{Hydraulic Flow Barrier (HFB) Package}
\input{gwf/hfb}
...
\newpage
\subsection{Constant-Head (CHDG) Package -- Grid Array-Based Input}
\input{gwf/chdg}
...
\newpage
\subsection{Well (WELG) Package -- Grid Array-Based Input}
\input{gwf/welg}
...
\newpage
\subsection{Drain (DRNG) Package -- Grid Array-Based Input}
\input{gwf/drng}
...
\newpage
\subsection{River (RIVG) Package -- Grid Array-Based Input}
\input{gwf/rivg}
...
\newpage
\subsection{General-Head Boundary (GHBG) Package -- Grid Array-Based Input}
\input{gwf/ghbg}
...
\newpage
\subsection{Recharge (RCHA) Package -- Layer Array-Based Input}
\input{gwf/rcha}
...
\newpage
\subsection{Evapotranspiration (EVTA) Package -- Layer Array-Based Input}
\input{gwf/evta}
...
\newpage
\subsection{Lake (LAK) Package} \label{sec:lakpak}
\input{gwf/lak}
