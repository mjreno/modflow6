...
module GweUzeInputModule
  ...
  type GweUzeParamFoundType
    ...
    logical :: options_temperature = .false.
  ...
  logical :: gwe_uze_is_advanced = .true.
  ...
  type(InputParamDefinitionType), parameter :: &
    gweuze_options_temperature = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'UZE', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gweuze_infiltration = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'UZE', & ! subcomponent
    'PERIOD', & ! block
    'INFILTRATION', & ! tag name
    'INFILTRATION', & ! fortran variable
    'DOUBLE', & ! type
    '', & ! shape
  ...
  type(InputParamDefinitionType), parameter :: &
    gweuze_uzet = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'UZE', & ! subcomponent
    'PERIOD', & ! block
    'UZET', & ! tag name
    'UZET', & ! fortran variable
    'DOUBLE', & ! type
    '', & ! shape
