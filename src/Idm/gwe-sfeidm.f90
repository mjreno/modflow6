...
module GweSfeInputModule
  ...
  type(InputParamDefinitionType), parameter :: &
    gwesfe_options_temperature = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'SFE', & ! subcomponent
    'OPTIONS', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwesfe_rainfall = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'SFE', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwesfe_evaporation = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'SFE', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwesfe_runoff = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'SFE', & ! subcomponent
    'PERIOD', & ! block
  ...
  type(InputParamDefinitionType), parameter :: &
    gwesfe_inflow = InputParamDefinitionType &
    ( &
    'GWE', & ! component
    'SFE', & ! subcomponent
    'PERIOD', & ! block
