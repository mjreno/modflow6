...
Extended \mf can read and write version 4 (NetCDF-4) NetCDF files. Two different formats are supported for each (input and output) file type: a structured format and a UGRID based unstructured LAYERED MESH format. Each format aims to be cf-conventions complient.
