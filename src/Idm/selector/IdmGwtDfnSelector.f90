...
contains
  ...
  function gwt_param_definitions(subcomponent) result(input_definition)
    ...
    case ('MVT')
      call set_param_pointer(input_definition, gwt_mvt_param_definitions)
    case ('SSM')
  ...
  function gwt_aggregate_definitions(subcomponent) result(input_definition)
    ...
    case ('MVT')
      call set_param_pointer(input_definition, gwt_mvt_aggregate_definitions)
    case ('SSM')
  ...
  function gwt_idm_multi_package(subcomponent) result(multi_package)
    ...
    case ('MVT')
      multi_package = gwt_mvt_multi_package
    case ('SSM')
  ...
  function gwt_idm_subpackages(subcomponent) result(subpackages)
    ...
    case ('MVT')
      call set_subpkg_pointer(subpackages, gwt_mvt_subpackages)
    case ('SSM')
